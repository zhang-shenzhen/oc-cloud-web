  ...
  >
    ...
    <div class="d2-layout-header-aside-content" flex="dir:top">
      ...
      <div
        ...
        style="box-shadow:0 3px 13px 0 rgba(0,0,0,0.07);"
        flex-box="0"
        flex
      >
        <div
          class="logo-group"
          style="background:#33395C"
          :style="{ width: asideCollapse ? asideWidthCollapse : asideWidth }"
          flex-box="0"
        >
          <span>智能营销平台</span>
          <!-- <img
            style="width:45px;height:40px;margin-top:10px;"
            src="../logo/all.png"
          > -->
              ...
              <div class="d2-theme-container-main-body" flex-box="1">
                <transition :name="transitionActive ? 'fade-transverse' : ''">
                  <keep-alive :include="keepAlive">
                    <router-view />
                    <el-backtop
                      target=".d2-container-full__body"
                      :bottom="10"
                    />
                  </keep-alive>
                </transition>
    ...
    getUserInfo() {
      ...
      if (userInfo) {
        if (cookieGet('Httpheader')) {
          ...
          this.userInfoSet(
            Object.assign(JSON.parse(userInfo), { ChannelId: ChannelId })
          )
        }
      } else {
        this.userInfoSet({})
