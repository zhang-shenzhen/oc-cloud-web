  ...
  <el-dialog width="400px"
    ...
    <el-form ref="dataForm"
      ...
      <el-form-item prop="comfirmPassword"
                    :label="$t('updatePassword.comfirmPassword')">
        <el-input v-model="dataForm.comfirmPassword"
                  type="password"
                  :placeholder="$t('updatePassword.comfirmPassword')" />
      </el-form-item>
    </el-form>
  ...
  methods: {
    ...
    dataFormSubmitHandle: debounce(function () {
      this.$refs['dataForm'].validate((valid) => {
        ...
        console.log(option, info, 'option=====', this.dataForm)
        changePassword(option).then(res => {
          if (res.code == 0) {
            this.$message({
        ...
        // sysUserService.updatePassword(this.dataForm).then(res => {
        //     this.$message({
        //       message: this.$t('prompt.success'),
        //       type: 'success',
        //       duration: 500,
