...
let node={}
//客户涞源
node.CustomersourceList = [
  {id:1,label:'Repeat Customer'},
  {id:2,label:'Seminar Event'},
  {id:3,label:'Network(internal)'},
  {id:4,label:'Network (external)'},
  {id:5,label:'Tender'},
  {id:6,label:'Online'},
  {id:7,label:'Cold call'},
  {id:8,label:'IE'},
  {id:9,label:'Training'},
  {id:10,label:'Wechat'}
]
...
//公司类型
node.CompanyTypeList = [
  {id:1,label:'Government'},
  {id:2,label:'Private-Singapore'},
  {id:3,label:'Private-Local'},
  {id:4,label:'Private - International'},
  {id:5,label:'Mixed Ownership Enterprise'},
  {id:6,label:'Vendor/contractor'},
  {id:7,label:'Design institute'}
]
