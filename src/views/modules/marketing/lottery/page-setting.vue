          ...
          >
            ...
            >
              <div class="img-upload">
                <img
                  v-if="form.backgroundPic != null && form.backgroundPic != ''"
                  style="width:100%;"
            ...
            >
              <div class="img-upload">
                <img
                  v-if="form.titlePic != null && form.titlePic != ''"
                  style="width:100%;"
            ...
            >
              <div style="display:flex;">
                ...
                <el-input v-model="form.buttonRGB" size="mini" :disabled="$route.query.OTP == 3"/>
              </div>
            </el-form-item>
            <el-form-item
              label="转盘图片"
            ...
            >
              <div class="img-upload">
                <img
                  v-if="form.turntablePic != null && form.turntablePic != ''"
                  style="width:100%;"
...
export default {
  ...
  methods: {
    ...
    imageSuccessCBK1(arr) {
      console.log(arr)
      this.form.backgroundPic = arr[0].url[0].url;
    },
    imageSuccessCBK2(arr) {
      this.form.titlePic = arr[0].url[0].url;
    },
    imageSuccessCBK3(arr) {
      this.form.turntablePic = arr[0].url[0].url;
    },
    // 选择转盘位置change
