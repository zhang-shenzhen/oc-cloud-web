    ...
    <div class="sweepstakesBackground">
      <div class="tab-head-btn">
        <div class="tab-head-btn-l">
          ...
          <el-button
            type="primary"
            size="mini"
            @click="$router.push({name:'add-lottery',query:{
              OTP:1
            }})"
          >添加活动</el-button>
        </div>
      ...
      >
        ...
        <template v-slot:operating="operating">
          ...
          >数据</el-button>
          <el-button
            v-if="operating.operating.status!=4 && operating.operating.status==1"
            size="mini"
            type="text"
          ...
          <el-button
            ...
            size="mini"
            type="text"
            @click="LookThis(operating.operating)"
          >查看</el-button>
          <!-- <el-button
...
import { lotterys, stopLottery, startLottery, deleteLottery, copyLottery } from '@/api/marketing/lottery'
export default {
  components: {
  ...
  methods: {
    ...
    upDateThis(operating) {
      this.$router.push({ name: 'add-lottery', query: {
        OTP: 2,
        id: operating.id
      }})
    },
