<template>
  <d2-container class="page">
    <h3 class="list-title"
        style="margin-top:-10px;">{{ $t('brand.CheckIn') }}</h3>
...
export default {
  ...
  methods: {
    ...
    submitForm (formName) {
      ...
      this.subInfo.international = {
        title: this.ruleForm.titleEn,
        description: this.ruleForm.descriptionEn,
      }
      this.days = [];
