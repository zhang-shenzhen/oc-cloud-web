<template>
  <d2-container class="page">
    ...
    <el-dialog title="卡券列表" width="70%" :visible.sync="dialogFormVisible">
      <el-table
        :data="couponList"
        size="mini"
        max-height="500"
...
export default {
  ...
  methods: {
        ...
        if (res.code == 0) {
          ...
          if (res.data) {
            ...
            this.ruleForm.date = [
              ...
              formatDate(new Date(res.data.endTime), 'yyyy-MM-dd')
            ]
            console.log('res.data', res.data)
            res.data.attendanceAward[0] = res.data.attendanceAward[0]
              ? res.data.attendanceAward[0]
              : {
                  awardObject: {
                    num: null
                  }
            ...
            this.ruleForm.num =
              res.data.attendanceAward[0].awardObject.num || null
            ...
            this.ruleForm.international = res.data.international
              ? JSON.parse(res.data.international)
              : {
                  title: null,
                  description: null
                }
    ...
    delectSubData(arr) {
      const option = JSON.parse(JSON.stringify(arr))
      console.log(arr, option, 111111111111111)
